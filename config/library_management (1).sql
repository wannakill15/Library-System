...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2024 at 05:34 AM
...
INSERT INTO `books` (`BookID`, `ResourceID`, `Author`, `ISBN`, `Publisher`, `Edition`, `PublicationDate`) VALUES
(4, 7, 'ewq', '123123', 'qwe', 'qwe', '0000-00-00');
...
(8, '', 'staff', 'staff@staff.com', '$2y$10$B5Tm73qSDWjn/Z2jtEk9Lu25b4Ji365jXGvhNrBlO3BVscMj35Lja', 'staff', 0),
(12, 'student', 'student', 'student@student.com', '$2y$10$7RAaNi/z.ZPu5NXyJlhk/.HpYJnlWhHvODnaOcdpYYdg.FpepJoG6', 'student', 0);
...
--
ALTER TABLE `activitylog`
  ADD CONSTRAINT `activitylog_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `users` (`id`);
...
--
ALTER TABLE `borrowing_history`
  ADD CONSTRAINT `borrowing_history_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `users` (`id`);

--
-- Constraints for table `finepayments`
--
ALTER TABLE `finepayments`
  ADD CONSTRAINT `finepayments_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `finepayments_ibfk_2` FOREIGN KEY (`TransactionID`) REFERENCES `borrowingtransactions` (`TransactionID`);
