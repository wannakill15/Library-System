...
<body class="bg-gray-100 min-h-screen p-6">
    <div class="container mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <div class="grid md:grid-cols-2 gap-6">
                ...
                <?php if (isset($_POST['user_id'])): ?>
                    ...
                    <?php else: ?>
                        <div class="mt-4 p-4 bg-yellow-100 border border-yellow-300 text-yellow-700 rounded">
                            <p class="text-center">No borrowing history found for the selected user.</p>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
            ...
            <div class="space-y-6">
                <div class="bg-gray-50 p-6 rounded-lg shadow-md">
                    ...
                    <?php if (isset($_POST['popular_books'])): ?>
                        ...
                        <?php else: ?>
                            <div class="mt-4 p-4 bg-yellow-100 border border-yellow-300 text-yellow-700 rounded">
                                <p class="text-center">No popular books found.</p>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
                ...
                <div class="bg-gray-50 p-6 rounded-lg shadow-md">
                    ...
                    <?php if (isset($_POST['overdue_books'])): ?>
                        ...
                        <?php else: ?>
                            <div class="mt-4 p-4 bg-yellow-100 border border-yellow-300 text-yellow-700 rounded">
                                <p class="text-center">No overdue books found.</p>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
        ...
        <div class="mt-6 bg-gray-50 p-6 rounded-lg shadow-md">
            ...
            <?php if (isset($_POST['inventory_summary'])): ?>
                ...
                <?php else: ?>
                    <div class="mt-4 p-4 bg-yellow-100 border border-yellow-300 text-yellow-700 rounded">
                        <p class="text-center">No inventory summary available.</p>
                    </div>
                <?php endif; ?>
            <?php endif; ?>
        </div>
